...
- Slots field
- Manual planned uptime/schedule field, for example `17:00 to 02:00 CET`
...
!server list
!server info project
!server set project "Project Zomboid" "SIN Corp Community Server" "51.38.107.44:1025" "password" online "16" "Workshop link" "17:00 to 02:00 CET" "Notes here"
!server edit project uptime "17:00 to 02:00 CET"
...
The uptime field is manual text. It does not automatically start or stop the server. Use it to tell members when you expect the server to be available, for example `17:00 to 02:00 CET`, `Weekend only`, or `Open after stream`.
